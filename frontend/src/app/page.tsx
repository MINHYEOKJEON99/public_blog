...
const mockPosts = [
  {
    ...
    excerpt: 'React의 최신 Concurrent 기능과 Next.js 15의 App Router를 활용하여 성능과 사용자 경험을 극대화하는 실전 가이드입니다.',
    ...
    category: { id: '1', name: 'Frontend', slug: 'frontend', color: 'from-blue-500 to-cyan-500' },
    tags: [
  ...
  },
  {
    ...
    excerpt: 'TypeScript, Node.js, Prisma를 활용한 현대적인 백엔드 아키텍처 설계부터 배포까지의 완벽 가이드',
    ...
    category: { id: '2', name: 'Backend', slug: 'backend', color: 'from-green-500 to-emerald-500' },
    tags: [
  ...
  },
  {
    ...
    excerpt: '실제 프로덕션 환경에서 사용되는 디자인 시스템을 만들고 관리하는 실전 노하우와 베스트 프랙티스',
    ...
    category: { id: '3', name: 'Design', slug: 'design', color: 'from-purple-500 to-pink-500' },
    tags: [
  ...
  },
  {
    ...
    excerpt: '생성형 AI를 개발 프로세스에 통합하여 생산성을 극대화하는 실전 전략과 도구들',
    ...
    category: { id: '4', name: 'AI/ML', slug: 'ai-ml', color: 'from-indigo-500 to-purple-500' },
    tags: [
...
const mockCategories = [
  { id: '1', name: 'Frontend', slug: 'frontend', postsCount: 142, color: 'from-blue-500 to-cyan-500', icon: Code },
  { id: '2', name: 'Backend', slug: 'backend', postsCount: 98, color: 'from-green-500 to-emerald-500', icon: Database },
  { id: '3', name: 'Design', slug: 'design', postsCount: 67, color: 'from-purple-500 to-pink-500', icon: Palette },
  { id: '4', name: 'AI/ML', slug: 'ai-ml', postsCount: 34, color: 'from-indigo-500 to-purple-500', icon: Lightbulb },
  { id: '5', name: 'DevOps', slug: 'devops', postsCount: 23, color: 'from-orange-500 to-red-500', icon: Globe },
  { id: '6', name: 'Mobile', slug: 'mobile', postsCount: 56, color: 'from-teal-500 to-blue-500', icon: Coffee }
]
...
export default function Home() {
  ...
  const [currentStats, setCurrentStats] = useState(statsData.map(stat => ({ ...stat, displayValue: '0' })))
    ...
    <Layout>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center max-w-6xl">
          ...
          >
            <Badge variant="gradient" className="mb-6" animated pulse>
          ...
          >
            <div className="relative group">
              ...
              <div className="relative glass rounded-2xl p-2 border-white/20 dark:border-gray-700/30">
                <div className="flex items-center space-x-3">
                  ...
                  <Input
                    ...
                    variant="glass"
                  />
                  <Button size="lg" variant="gradient" className="mr-2">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-4xl md:text-5xl font-bold mb-2">트렌딩 포스트</h2>
                <p className="text-muted-foreground text-lg">개발자들이 가장 주목하는 최신 콘텐츠</p>
              </div>
            </div>
          ...
          >
            <Tabs value={selectedCategory} onValueChange={setSelectedCategory} className="mb-12">
              <TabsList variant="pills" className="grid w-full grid-cols-4 lg:grid-cols-7 max-w-4xl mx-auto">
                <TabsTrigger value="all" variant="pills" className="text-sm">
                  전체
                </TabsTrigger>
                {mockCategories.map((category) => (
                  <TabsTrigger key={category.slug} value={category.slug} variant="pills" className="text-sm">
                    {category.name}
                  </TabsTrigger>
                ))}
              </TabsList>
              ...
              {filteredPosts.map((post, index) => (
                <motion.div
                  ...
                  className={cn(
                    ...
                    index === 0 && viewMode === 'grid' ? "md:col-span-2 md:row-span-1" : "",
                  ...
                  <Card className="overflow-hidden border-0 shadow-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 h-full">
                    ...
                    <div className={cn(
                      ...
                      <div className="absolute top-4 left-4 flex space-x-2">
                        {post.trending && (
                          <Badge variant="gradient" className="text-xs" animated>
                      ...
                      <div className="absolute bottom-4 right-4 flex space-x-2">
                        ...
                        <Badge 
                          variant={post.difficulty === 'beginner' ? 'success' : post.difficulty === 'intermediate' ? 'warning' : 'destructive'}
                          size="sm"
                        >
                          {post.difficulty === 'beginner' ? '초급' : post.difficulty === 'intermediate' ? '중급' : '고급'}
                        </Badge>
                      </div>
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <motion.div
                          ...
                          whileTap={{ scale: 0.9 }}
                        >
                          <Button size="lg" variant="glass" className="rounded-full w-16 h-16">
                    ...
                    <div className="p-6 flex-1">
                      ...
                      <CardTitle className={cn(
                        ...
                        index === 0 && viewMode === 'grid' ? "text-2xl md:text-3xl" : "text-xl"
                      )}>
                        {post.title}
                      </CardTitle>
                      ...
                      <CardDescription className={cn(
                        "line-clamp-3 mb-6",
                        index === 0 && viewMode === 'grid' ? "text-base" : "text-sm"
                      )}>
                        {post.excerpt}
                      </CardDescription>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                          <QuickTooltip content="좋아요" side="top">
                          ...
                          <QuickTooltip content="댓글" side="top">
                          ...
                          <QuickTooltip content="조회수" side="top">
                          ...
                          <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <QuickTooltip content="북마크" side="top">
                              <Button variant="ghost" size="sm" className="h-8 w-8">
                                <Bookmark className="w-4 h-4" />
                              </Button>
                            </QuickTooltip>
                            <QuickTooltip content="공유" side="top">
                              <Button variant="ghost" size="sm" className="h-8 w-8">
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        {post.tags.map((tag) => (
                          <Badge key={tag.id} variant="secondary" size="sm" className="hover:bg-primary hover:text-primary-foreground transition-colors cursor-pointer">
                            #{tag.name}
                          </Badge>
                        ))}
                      </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              각 분야의 전문가들이 엄선한 고품질 콘텐츠로 체계적인 학습이 가능합니다
            </p>
          </motion.div>
              ...
              >
                <Link href={`/category/${category.slug}`}>
                  <Card className="p-8 text-center border-0 shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                    ...
                    {/* Progress Bar */}
                    <Progress 
                      value={(category.postsCount / Math.max(...mockCategories.map(c => c.postsCount))) * 100}
                      variant="gradient"
                      className="mb-4"
                      animated
                    />
